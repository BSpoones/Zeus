package org.bspoones.chloris.command
...
import org.bspoones.chloris.command.handler.NsfwHandler
import org.bspoones.chloris.command.handler.OptionHandler
...
open class Command : ListenerAdapter() {
    ...
    override fun onMessageReceived(event: MessageReceivedEvent) {
        ...
        if (!content.startsWith(CommandRegister.getPrefix(event.guild.idLong))) return
